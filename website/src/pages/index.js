  ...
  return (
    <section className={styles.installation}>
      <div className="container">
        ...
        <CodeBlock className="language-bash">go get -u github.com/FJSDS/gnet</CodeBlock>
        <p className="hero--subsubtitle">gnet is available as a Go module, with Go 1.11 Modules support (Go 1.11+), just simply import "github.com/FJSDS/gnet" in your source code and go [build|run|test] will download the necessary dependencies automatically.</p>
      </div>
    </section>
  );
}
      ...
      <header className={classnames('hero', 'hero--full-height', styles.indexHeroBanner)}>
        <div className="container container--fluid">
          ...
          <div className="hero--buttons">
            <Link to="https://github.com/FJSDS/gnet" className="button button--primary"><i className="feather icon-github"></i> View on Github</Link>
          </div>
