      ...
      <main>
        <section>
          <div className="container">
            <div className="row">
              ...
              <div className="col">
                <a href="https://github.com/FJSDS/gnet" target="_blank" className="panel panel--button">
                  <div className="panel--icon">
        ...
        <section>
          <div className="container">
            ...
            <p>
              Gnet is <a href="https://github.com/FJSDS/gnet">open-source</a> and welcomes contributions. A few guidelines to help you get started:
            </p>
            <ol>
              <li>Read our <a href="https://github.com/FJSDS/gnet/blob/master/CONTRIBUTING.md" target="_blank">contribution guide</a>.</li>
              <li>Start with <a href="https://github.com/FJSDS/gnet/issues?q=is%3Aissue+label%3A%22good+first+issue%22" target="_blank">good first issues</a>.</li>
            ...
            <ol>
              ...
              <li><a href="https://pkg.go.dev/github.com/FJSDS/gnet?tab=doc" target="_blank">Gnet Documentaions</a></li>
            </ol>
          </div>
        </section>
      </main>
